...
const expertiseData = [
  {
    ...
    text: "Crafting responsive, high-fidelity user interfaces with HTML5, CSS3, React.js, Tailwind CSS, and Bootstrap.",
  ...
  },
  {
    ...
    text: "Architecting secure REST APIs and scalable backend systems using Node.js, Express.js, and Java.",
  ...
  },
  {
    ...
    text: "Designing and managing relational and NoSQL database schemas using MySQL and MongoDB.",
    tag: "DATA & STORAGE",
  ...
  },
  {
    number: "04",
    title: "Tools & Cloud",
    text: "Version control with Git/GitHub, deploying applications on Netlify and Vercel, and foundational AWS knowledge.",
    tag: "DEVOPS & CLOUD",
