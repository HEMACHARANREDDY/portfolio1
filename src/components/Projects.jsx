...
const projectsData = [
  {
    title: "Meal Mitra",
    category: "Food Donation Web App",
    description: "Developed a full-stack MERN application connecting food donors with NGOs and people in need.",
    tags: ["MongoDB", "Express", "React", "Node.js", "Tailwind CSS", "Twilio API", "Gemini AI"],
    match: "99%",
    episode: "S01 E01"
  },
  {
    title: "Clean Mitra",
    category: "Waste Management App",
    description: "Developed a desktop application with Admin, Driver, and User roles for efficient waste management.",
    tags: ["Java", "JavaFX", "MongoDB", "Maven"],
    match: "97%",
    episode: "S01 E02"
  },
  {
    title: "LoadFlow",
    category: "Load Balancing System",
    description: "Engineered a load balancer that routes traffic across multiple backend servers using round-robin and least-connections algorithms.",
    tags: ["Python", "Sockets", "Multi-threading", "Redis"],
    match: "98%",
    episode: "S01 E03"
  }
];
