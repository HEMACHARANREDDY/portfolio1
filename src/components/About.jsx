        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">K Hema Charan Reddy</span>, a B.Tech student in Computer Science at Koneru Lakshmaiah Education Foundation.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                Dedicated and enthusiastic student adept in solving problems and adapting to the latest advancements in the technology sector. Continuously enhancing abilities through real applications and initiatives.
              </p>
            </div>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>Software Development Engineer Intern at <strong className="text-white">AlgoUniversity</strong>.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Certified <strong className="text-white">AWS Cloud Practitioner</strong> and <strong className="text-white">MongoDB Associate Developer</strong>.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Developed <strong className="text-white">web analyzers</strong> and automated scripts to optimize performance.</span>
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Java', 'JavaScript', 'React', 'Node.js', 'Express', 'MongoDB', 'Tailwind CSS'].map((tech, idx) => (
                <span
                  key={idx}
