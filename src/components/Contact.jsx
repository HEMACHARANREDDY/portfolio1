...
const Contact = () => {
  ...
  // Handle form submission logic with Web3Forms
  const handleSubmit = async (e) => {
    ...
    const data = {
      access_key: "db10da2f-74cc-41e1-b87d-61064a5ae569", 
    ...
    try {
      ...
      if (result.success) {
        alert(`Thanks ${formData.firstName}! Message sent successfully to your inbox.`);
        setFormData({ firstName: '', lastName: '', email: '', message: '', permission: false });
      } else {
        alert("Something went wrong. Did you add your Web3Forms Access Key?");
      }
    } catch (error) {
