...
import pictureImg from '../assets/Portfolio/charan.jpg';
...
const Hero = () => {
  ...
  const developerRoles = [
    ...
    'ORIGINAL SERIES // SDE INTERN',
    'BLOCKBUSTER // CLOUD PRACTITIONER',
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full min-h-[100svh] lg:h-screen bg-[#050505] overflow-x-hidden lg:overflow-hidden flex flex-col justify-between select-none cursor-none"
    >
      <style>{`
        @keyframes marquee {
      ...
      <div ref={contentRef} className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 h-full flex flex-col justify-between pt-32 lg:pt-24 pb-12 lg:pb-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 my-auto">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-5 text-left">
            ...
            <div className="hero-anim-item flex items-center gap-3 text-xs font-mono text-red-400 font-bold">
              ...
              <span className="text-white/40">•</span>
              <span className="text-white/70">Java & Cloud</span>
            </div>

            <p className="hero-anim-item text-sm md:text-base text-white/80 font-light leading-relaxed max-w-md drop-shadow">
              Architecting robust full-stack systems, building scalable MERN applications, and optimizing web performance.
            </p>
          ...
          <div className="hero-anim-item lg:col-span-3 flex flex-col items-start lg:items-end space-y-4 text-left lg:text-right">
            <div className="p-5 bg-black/80 backdrop-blur-2xl border border-white/15 rounded-xl shadow-2xl max-w-xs">
              ...
              <p className="text-xs text-white/80 leading-relaxed font-light">
                AWS Certified Cloud Practitioner, MongoDB Associate Developer, AlgoUniversity SDE Intern.
              </p>
            </div>
          </div>
