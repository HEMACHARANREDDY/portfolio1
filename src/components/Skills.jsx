...
const skillCategories = [
  { 
    ...
    desc: 'Writing clean, efficient, and robust code across multiple paradigms and architectures.', 
    tag: 'LANGUAGES',
    skills: ['Java', 'JavaScript', 'C'] 
  },
  { 
    title: 'API Dev & Testing', 
    desc: 'Designing and validating secure, scalable, and high-performance RESTful architectures.', 
    tag: 'API',
    skills: ['REST APIs', 'Postman'] 
  },
  { 
    title: 'Frontend Technologies', 
    desc: 'Crafting responsive and interactive user interfaces for modern web applications.', 
    tag: 'FRONTEND',
    skills: ['HTML5', 'CSS3', 'React.js', 'Bootstrap', 'Tailwind CSS'] 
  },
  { 
    title: 'Backend & Databases', 
    desc: 'Building robust server-side logic and managing scalable data architectures.', 
    tag: 'BACKEND',
    skills: ['Node.js', 'Express.js', 'MongoDB', 'MySQL'] 
  },
  { 
    title: 'Cloud & Tools', 
    desc: 'Leveraging modern version control and cloud deployment platforms for seamless delivery.', 
    tag: 'DEVOPS',
    skills: ['Git', 'GitHub', 'VS Code', 'Netlify', 'Vercel', 'AWS'] 
  },
  { 
    title: 'Networking Fundamentals', 
    desc: 'Understanding core network protocols and architectures for reliable communications.', 
    tag: 'NETWORKING',
    skills: ['TCP/IP', 'HTTP/HTTPS', 'DNS', 'WebSockets', 'Wireshark'] 
  },
];
