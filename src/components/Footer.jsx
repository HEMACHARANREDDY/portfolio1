      ...
      <div className="max-w-7xl mx-auto flex flex-col space-y-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-xs font-mono text-white/60">
          <div className="flex items-center gap-6">
            <a 
              href="https://github.com/HEMACHARANREDDY" 
              target="_blank" 
            ...
            <a 
              href="https://linkedin.com/in/hema-charan-reddy" 
              target="_blank" 
              rel="noopener noreferrer"
              className="hover:text-red-500 transition-colors uppercase tracking-wider"
            >
          ...
          <div className="flex flex-col text-right text-white/40 tracking-widest uppercase gap-1 mt-4 md:mt-0">
            <span>LOCATION: HYDERABAD, INDIA</span>
            <span className="text-[10px]">EMAIL: hemacharan499@gmail.com</span>
            <span className="text-[10px]">PHONE: +91-7893035588</span>
          </div>
        </div>
